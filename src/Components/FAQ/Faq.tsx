        ...
        <div className="faq__content--questions">
          <div className=" faq__content--questions--card--exposed">
            <div className="faq__content--questions--card--exposed--div">
              <h1>
                What is Genesis DAO and how does it differ from traditional
                DAOs?
              </h1>
            ...
            <p>
              ...
              initially, followed by a building phase of which the community
              will be part of in every step of the way.
            </p>
          </div>
          <div className="faq__content--questions--card">
            {" "}
            <h1>
